...
export const totalPagesForNowShowingMovies = createSelector(getMovieState, (state: MoviesState) => state.totalPagesForNowShowingMovies);
export const totalPagesForUpcomingMovies = createSelector(getMovieState, (state: MoviesState) => state.totalPagesForUpcomingMovies);
export const loadingSelector = createSelector(getMovieState, (state: MoviesState) => state.loading);
